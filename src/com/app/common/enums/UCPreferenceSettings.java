...
public enum UCPreferenceSettings {
	/**
	 * Whether is the first use of the application
	 *
	 */
	SETTINGS_FIRST_USE("com.ucan.app_first_use", Boolean.TRUE), SETTINGS_UCAN_ACCOUNT(
	...
	/** 新消息震动 */
	SETTINGS_NEW_MSG_SHAKE("com.ucan.app_new_msg_shake", true), SETTING_CHATTING_CONTACTID(
			"com.ucan.app_chatting_contactid", ""),
	/** 图片缓存路径 */
	 ...
	 */
	private UCPreferenceSettings(String id, Object defaultValue) {
		this.mId = id;
	 ...
	 * {@link com.ucan.app.common.utils.ECPreferenceSettings} from its. unique
	 * identifier
	 *
	 * @param id
	 ...
	 */
	public static UCPreferenceSettings fromId(String id) {
		UCPreferenceSettings[] values = values();
