...
import com.ucan.app.chat.chatting.base.EmojiconHandler;
import com.ucan.app.chat.chatting.emoji.Emojicon;
import com.ucan.app.chat.chatting.emoji.People;
import com.ucan.app.chat.chatting.model.CCPEmoji;
	...
	public static void initEmoji() {
		...
		for (Emojicon emojicon : data) {
			if (emojicon.getEmoji() != null) {
				...
				if (unicode > 0xff) {
					emoji.setId(EmojiconHandler.getEmojiResource(UCApplication
