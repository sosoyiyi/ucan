...
public class Phone {
	...
	public Phone(int type, String phoneNum) {
		super();
		phoneNum = VeryUtils.filterUnNumber(phoneNum);
		this.type = type;
	...
	public int hashCode() {
		...
		/*
		 * if (type == 0) { result = prime * result + ((customLabel == null) ? 0
	...
	public boolean equals(Object obj) {
		...
		if (phoneNum == null) {
			...
			return false;
		/*
		 * if (type != other.type) return false; if (type == 0) { if
		 * (customLabel == null) { if (other.customLabel != null) return false;
		 * } else if (!customLabel.equals(other.customLabel)) return false; }
		 */
		return true;
	}
