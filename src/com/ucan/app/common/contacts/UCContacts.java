...
import com.ucan.app.base.storage.AbstractSQLManager;
 ...
 */
public class UCContacts  implements Parcelable {

    public static final Parcelable.Creator<UCContacts> CREATOR = new Creator<UCContacts>() {
        @Override
        public UCContacts[] newArray(int size) {
            return new UCContacts[size];
        }

        @Override
        public UCContacts createFromParcel(Parcel in) {
            return new UCContacts(in);
        }
    };
    ...
    public UCContacts(String contactId) {
        this.contactid = contactId;
    }
